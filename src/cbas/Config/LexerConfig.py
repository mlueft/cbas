...
class Matrix():
    ...
    Definitions = {
        ...
        "resume":               { "order": 1780, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.RESUME,      "expression": "(?i)RESUME"                           }, # s $d6
        "rsppos":               { "order":  500, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.RSPPOS,      "expression": "(?i)RSPPOS"                           }, # f $ce $05
        "scnclr":               { "order":  510, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.SCNCLR,      "expression": "(?i)SCNCLR"                           }, # s $e8
        "sqr":                  { "order":  520, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.SQR,         "expression": "(?i)SQR"                              }, # f $BA
        ...
        "envelope":             { "order":  140, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.ENVELOPE,    "expression": "(?i)ENVELOPE"                         },
        "endofline":            { "order": 9999, "handler": Tokenizer.defaultHandler     , "type": TokenTypes.LINEEND,     "expression": ""                                     },

        "pi":                   { "type": "alias", "target":"pisign",         "expression": "(?i)PI"                               },
            
        #C64List
        "cl_pi":                { "type": "alias", "target":"pisign",       "expression": "(?i)\{\$ff\}"                           },

        # PETCAT
        "pc_pi":                { "type": "alias", "target":"pisign",       "expression": "(?i)~"                                  },

        # BASTEXT
        "bt_pi":                { "type": "alias", "target":"pisign",       "expression": "(?i)\{pi\}"                             },
    ...
    Matrix = {
        ...
        "pisign":               [ 0,    0,    1,    0,    1,    0,    0,    0,    0    ],
        "pi":                   [ 0,    0,    1,    0,    1,    0,    0,    0,    0    ],
        ...
        "curlyopen":            [ 0,    0,    1,    0,    0,    0,    0,    0,    0    ],
        "curlyclose":           [ 0,    0,    1,    0,    0,    0,    0,    0,    0    ],
        ...
        #BASTEXT
        "bt_pi":                [ 0,    0,    1,    1,    1,    1,    1,    1,    1    ],
        "pc_pi":                [ 0,    0,    1,    1,    1,    1,    1,    1,    1    ],
        "cl_pi":                [ 0,    0,    1,    1,    1,    1,    1,    1,    1    ],
